...
# Kat Styons / https://github.com/styonsk
...
get_EBS_List() {
  case $selection_method in
    ...
    instancetag)
      ...
      instance_selection_string="--filters Name=tag:$tag"
      instance_list=$(aws ec2 describe-instances --region $region $instance_selection_string --output text --query 'Reservations[*].Instances[*].InstanceId')
      ...
      ebs_selection_string="--filters Name=attachment.instance-id,Values=$instance_ids"
      ;;
